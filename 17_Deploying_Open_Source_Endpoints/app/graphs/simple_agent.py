...
def _build_model_with_tools():
    ...
    # Note: Tool binding is currently disabled due to compatibility issues
    # between langchain-together 0.3.1 and the current LangChain ecosystem.
    # The model works perfectly without tools for direct Q&A.
    
    # TODO: Re-enable tools when compatibility is fixed
    # bound_model = model.bind_tools(get_tool_belt())
    # return bound_model
